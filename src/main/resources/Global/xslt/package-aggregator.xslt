...
<xsl:stylesheet version="2.0"
	...
	<xsl:template name="test-case-info">
		...
		<div class="test-case-info">
			<h1>LOI Test Case <xsl:value-of select="$testCaseId"/>
			</h1>
			<br/>
			<h2>
	...
	<xsl:template name="cover-page">
		<div id="test-pkg-cover-page">
			...
			<br/>
			<br/>
			<h1>NIST Test Data</h1>
			<h1>Laboratory Orders Interface</h1>
			<br/>
			<br/>
			<br/>
			<h3>Version 1.2</h3>
	...
	<xsl:template name="css">
		<style type="text/css">
			@page {
				...
				@top-center {
					content: "NIST Test Data : Laboratory Orders Interface";
				}
				@bottom-center {
			...
			fieldset {text-align:center;}
         	...
         	<!-- table body -->
         	fieldset table tbody tr th {font-size:90%;text-align:left;background:#C6DEFF;}     	
         	fieldset table tbody tr td {font-size:90%;text-align:left;}
