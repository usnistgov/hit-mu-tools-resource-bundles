...
<xsl:stylesheet version="2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema"
    ...
    <xsl:param name="instructions" select="'No Specific Instructions'"></xsl:param>
    ...
    <xsl:template name="headerTemp">
        ...
        <xsl:choose>
            <xsl:when test="../../..[@id = 'MFN_M08']">
                ...
                <thead>
                    <tr>
                        <th colspan="{$colspan}" style="width:60%">Atomic Test : <xsl:value-of
                                select="OM1.2/OM1.2.2"/></th>
                        <th style="width:40%">Tester Comment</th>
                    </tr>
                </thead>
            ...
            <xsl:when test="../../..[@id = 'MFN_M10']">
                <thead>
                    <tr>
                        <th colspan="{$colspan}" style="width:60%">Panel : <xsl:value-of
                                select="OM1.2/OM1.2.2"/></th>
                        <th style="width:40%">Tester Comment</th>
                    </tr>
                </thead>
    ...
    <xsl:template name="specimen-tab">
        ...
        <xsl:if test="exists(following-sibling::OMC)">
            <xsl:if test="exists($specimen) or exists($spec)">
                <tr>
                    <td colspan="3" class="addSpace"/>
                </tr>
            </xsl:if>
            <xsl:for-each select="following-sibling::OMC">
                ...
                <xsl:if test="exists(OMC.4/OMC.4.2)">
                    <tr id="noColor">
                        <th style="width:20%"> Clinical Information Request </th>
                        <td>
                ...
                <xsl:if test="exists(OMC.5)">
                    <tr id="noColor">
                        <th rowspan="{count(OMC.5)+1}" style="width:20%">Collection Event/Process
                            Step</th>
                ...
                <xsl:if test="exists(OMC.6)">
                    <tr id="noColor">
                        <th style="width:20%">Communication Location</th>
                        <td>
                ...
                <xsl:if test="exists(OMC.7)">
                    <tr id="noColor">
                        <th style="width:20%">Answer Required</th>
                        <td>
                ...
                <xsl:if test="exists(OMC.11)">
                    <tr id="noColor">
                        <th rowspan="{count(OMC.11)+1}" style="width:20%">Answer Choices</th>
                        <td style="display:none"/>
    ...
    <xsl:template name="CPOE">
        ...
        <xsl:if test="exists(OM1.37)">
            <tr id="noColor">
                <th rowspan="{count(OM1.37)+1}" style="width:20%">Patient Preparation</th>
                <td style="display:none"/>
            </tr>
        ...
        <xsl:if test="exists(OM1.58)">
            <tr id="noColor">
                <th rowspan="{count(OM1.58)+1}" style="width:20%">Gender Restrictions</th>
                <td style="display:none"/>
            </tr>
        ...
        <xsl:if test="exists(OM1.59)">
            <tr id="noColor">
                <th rowspan="{count(OM1.59)+1}" style="width:20%">Age Restrictions</th>
                <td style="display:none"/>
            </tr>
        ...
        <xsl:if test="exists(OM1.52)">
            <tr id="noColor">
                <th rowspan="{count(OM1.52)+1}" style="width:20%">Replacement Test</th>
                <td style="display:none"/>
        ...
        <xsl:if
            ...
            <tr>
                <td colspan="3" class="addSpace"> </td>
            </tr>
        </xsl:if>
        ...
        <xsl:if test="exists(OM1.34)">
            ...
            <tr id="noColor">
                <th style="width:20%">Reflex Tests</th>
                <th>Trigger Rule</th>
                <th/>
            </tr>
    ...
    <xsl:template match="OM4">
        ...
        <xsl:if test="exists(OM4.15)">
            <tr id="noColor">
                <th rowspan="{count(OM4.15)+1}" style="width:20%">Specimen Handling Code</th>
                <td style="display:none"/>
            </tr>
        ...
        <xsl:if test="exists(OM4.11)">
            <tr id="noColor">
                <th style="width:20%">Minimum Collection Volume</th>
    ...
    <xsl:template name="Admin">
        <xsl:if test="exists(OM1.2)">
            ...
            <tr id="noColor">
                <th style="width:20%">Identifier assigned by lab </th>
                <th style="width:20%">Text</th>
                <th style="width:20%">Code System</th>
                <th/>
            </tr>
            <tr>
        ...
        <xsl:if test="exists(OM1.7)">
            ...
            <xsl:for-each select="OM1.7">
                <tr>
                    <xsl:copy-of select="util:formatData(OM1.7.1)"/>
                    <xsl:copy-of select="util:formatData(OM1.7.2)"/>
                    <xsl:copy-of select="util:formatData(OM1.7.3)"/>
                    <xsl:call-template name="commentTemplate"/>
                </tr>
            </xsl:for-each>
        </xsl:if>
        ...
        <xsl:if test="exists(following-sibling::OMC)">
            ...
            <xsl:for-each select="following-sibling::OMC">
                ...
                <xsl:if test="exists(OMC.12)">
                    <tr id="noColor">
                        <th style="width:20%">Character Limit</th>
                        <td colspan="2">
                ...
                <xsl:if test="exists(OMC.13)">
                    <tr id="noColor">
                        <th style="width:20%">Number of Decimals</th>
                        <td colspan="2">
            ...
            <xsl:for-each select="//CDM">
                <xsl:if test="$cdm = CDM.1/CDM.1.1">
                    ...
                    <xsl:for-each select="CDM.7">
                        <tr id="noColor">
                            <th style="width:20%">CPT4-code</th>
                            <td colspan="2">
    ...
    <xsl:function name="util:ID-text-format-withPosition">
            ...
            <xsl:if test="exists($data)">
                <tr>
                    <th style="text-indent: {$indent}; font-weight:{$font}">
                        <xsl:value-of select="util:posValue-if-repeat($ID, $pos, $las)"/>
                    </th>
                    <td>
    ...
    <xsl:function name="util:posValue-if-repeat">
        <xsl:param name="value"/>
        <xsl:param name="pos"/>
        <xsl:param name="total"/>
        <xsl:choose>
            <xsl:when test="$pos = 1 and $pos = $total">
                <xsl:value-of select="$value"/>
            </xsl:when>
            <xsl:otherwise>
                <xsl:value-of select="concat($value, '[', $pos, ']')"/>
            </xsl:otherwise>
        </xsl:choose>
    </xsl:function>
    <xsl:template name="headerforIV">
        ...
        <thead>
            ...
            <tr>
                ...
                <th style="width:20%">Data Element Name</th>
    ...
    <xsl:template name="generalInformation">
        ...
        <table>
            <xsl:call-template name="headerforIV">
                <xsl:with-param name="title">General Information</xsl:with-param>
            </xsl:call-template>
            <tbody>
                ...
                <xsl:for-each select="OM1.7">
                    ...
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('OM1.7', position(), last())"/>
                        </th>
                    ...
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.7.1', 'Identifier', OM1.7.1, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.7.2', 'Text', OM1.7.2, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.7.3', 'Name of Coding System', OM1.7.3, '20px', 'normal', position(), last())"
                    />
                </xsl:for-each>
                <xsl:copy-of
                ...
                <xsl:for-each select="OM1.33">
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('OM1.33', position(), last())"/>
                        </th>
                    ...
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.33.1', 'Identifier', OM1.33.1, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.33.2', 'Text', OM1.33.2, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.33.3', 'Name of Coding System', OM1.33.3, '20px', 'normal', position(), last())"
                    />
                </xsl:for-each>
                <xsl:for-each select="OM1.34">
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('OM1.34', position(), last())"/>
                        </th>
                    ...
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.34.1', 'Identifier', OM1.34.1, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.34.2', 'Text', OM1.34.2, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.34.3', 'Name of Coding System', OM1.34.3, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.34.4', ' Alternate Identifier', OM1.34.4, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.34.5', 'Alternate Text', OM1.34.5, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.34.6', 'Name of Alternate  Coding System', OM1.34.6, '20px', 'normal', position(), last())"
                    />
                </xsl:for-each>
                <xsl:for-each select="OM1.35">
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.35', 'Rules that Trigger Reflex Testing', ., '0px', 'normal', position(), last())"
                    />
                </xsl:for-each>
                <xsl:for-each select="OM1.37">
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.37', 'Patient Preparation', ., '0px', 'normal', position(), last())"
                    />
                </xsl:for-each>
                <xsl:copy-of
                ...
                <xsl:for-each select="OM1.40">
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.40', 'Service/Test/Observation Performance Schedule', ., '0px', 'normal', position(), last())"
                    />
                </xsl:for-each>
                <xsl:copy-of
                ...
                <xsl:for-each select="OM1.52">
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('OM1.52', position(), last())"/>
                        </th>
                    ...
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.52.1', 'Identifier', OM1.52.1, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.52.2', 'Text', OM1.52.2, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.52.3', 'Name of Coding System', OM1.52.3, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.52.4', ' Alternate Identifier', OM1.52.4, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.52.5', 'Alternate Text', OM1.52.5, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.52.6', 'Name of Alternate  Coding System', OM1.52.6, '20px', 'normal', position(), last())"
                    />
                </xsl:for-each>
                <xsl:for-each select="OM1.53">
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.53', 'Prior Results Instructions', ., '0px', 'normal', position(), last())"
                    />
                </xsl:for-each>
                <xsl:for-each select="OM1.54">
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.54', 'Special Instructions', ., '0px', 'normal', position(), last())"
                    />
                </xsl:for-each>
                <xsl:for-each select="OM1.55">
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.55', 'Test Relationship Category', OM1.55.2, '0px', 'normal', position(), last())"
                    />
                </xsl:for-each>
                <xsl:for-each select="OM1.56">
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('OM1.56', position(), last())"/>
                        </th>
                    ...
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.56.1', 'Identifier', OM1.56.1, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.56.2', 'Text', OM1.56.2, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.56.3', 'Name of Coding System', OM1.56.3, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.56.4', ' Alternate Identifier', OM1.56.4, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.56.5', 'Alternate Text', OM1.56.5, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.56.6', ' Name of Alternate Coding System', OM1.56.6, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.56.9', 'Original Text', OM1.56.9, '20px', 'normal', position(), last())"
                    />
                </xsl:for-each>
                <xsl:for-each select="OM1.57">
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('OM1.57', position(), last())"/>
                        </th>
                    ...
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.57.1', 'Quantity', OM1.57.1, '20px', 'normal', position(), last())"/>
                    <tr>
                        <th style="text-indent:20px">
                            <xsl:value-of
                                select="util:posValue-if-repeat('OM1.57.2', position(), last())"/>
                        </th>
                        <th>Units</th>
                        <th/>
                        <th/>
                    ...
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.57.2.1', ' Identifier', OM1.57.2/OM1.57.2.1, '30px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.57.2.2', 'Text', OM1.57.2/OM1.57.2.2, '30px', 'normal', position(), last())"/>
                ...
                <xsl:for-each select="OM1.58">
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('OM1.58', position(), last())"/>
                        </th>
                    ...
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.58.1', 'Identifier', OM1.58.1, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.58.2', 'Text', OM1.58.2, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.58.3', 'Name of Coding System', OM1.58.3, '20px', 'normal', position(), last())"/>
                ...
                <xsl:for-each select="OM1.59">
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('OM1.59', position(), last())"/>
                        </th>
                    ...
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.59.1', 'Low Value', OM1.59.1, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM1.59.2', 'High Value', OM1.59.2, '20px', 'normal', position(), last())"/>
    ...
    <xsl:template name="supporting-clinicalInfo">
        <table class="fourColumns">
            <xsl:call-template name="headerforIV">
                <xsl:with-param name="title">Supporting Clinical Information</xsl:with-param>
            </xsl:call-template>
            <tbody>
                ...
                <xsl:for-each select="OMC.5">
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('OMC.5', position(), last())"/>
                        </th>
                    ...
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OMC.5.1', 'Identifier', OMC.5.1, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OMC.5.2', 'Text', OMC.5.2, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OMC.5.3', 'Name of Coding System', OMC.5.3, '20px', 'normal', position(), last())"/>
                ...
                <xsl:if test="exists(OMC.11)">
                    <xsl:for-each select="OMC.11">
                        <tr>
                            <th>
                                <xsl:value-of
                                    select="util:posValue-if-repeat('OMC.11', position(), last())"/>
                            </th>
                        ...
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OMC.11.1', 'Identifier', OMC.11.1, '20px', 'normal', position(), last())"/>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OMC.11.2', 'Text', OMC.11.2, '20px', 'normal', position(), last())"/>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OMC.11.3', 'Name of Coding System', OMC.11.3, '20px', 'normal', position(), last())"
                        />
                    </xsl:for-each>
                </xsl:if>
                <xsl:copy-of
    ...
    <xsl:template name="numeric-observationInfo">
        <table>
            <xsl:call-template name="headerforIV">
                <xsl:with-param name="title"> Numeric Observation Information</xsl:with-param>
            </xsl:call-template>
            ...
            <tbody>
                ...
                <xsl:for-each select="OM2.6">
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('OM2.6', position(), last())"/>
                        </th>
                    ...
                    <xsl:if test="exists(OM2.6.1)">
                        <tr>
                            <th style="text-indent:10px">
                                <xsl:value-of
                                    select="util:posValue-if-repeat('OM2.6.1', position(), last())"
                                />
                            </th>
                            <th>Numeric Range</th>
                            <th/>
                        ...
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.6.1.1', 'Low Value', OM2.6.1/OM2.6.1.1, '20px', 'normal', position(), last())"/>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.6.1.2', 'High Value', OM2.6.1/OM2.6.1.2, '20px', 'normal', position(), last())"
                        />
                    </xsl:if>
                    <xsl:if test="exists(OM2.6.2)">
                        <tr>
                            <th style="text-indent:10px">
                                <xsl:value-of
                                    select="util:posValue-if-repeat('OM2.6.2', position(), last())"
                                />
                            </th>
                            <th>Administrative Sex</th>
                            <th/>
                            <th/>

                        </tr>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.6.2.1', 'Identifier', OM2.6.2/OM2.6.2.1, '20px', 'normal', position(), last())"/>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.6.2.2', 'Text', OM2.6.2/OM2.6.2.2, '20px', 'normal', position(), last())"/>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.6.2.3', 'Name of Coding System', OM2.6.2/OM2.6.2.3, '20px', 'normal', position(), last())"
                        />
                    </xsl:if>
                    <xsl:if test="exists(OM2.6.6)">
                        <tr>
                            <th>
                                <xsl:value-of
                                    select="util:posValue-if-repeat('OM2.6.6', position(), last())"
                                />
                            </th>
                        ...
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.6.6.1', 'Identifier', OM2.6.6/OM2.6.6.1, '20px', 'normal', position(), last())"/>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.6.6.2', 'Text', OM2.6.6/OM2.6.6.2, '20px', 'normal', position(), last())"/>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.6.6.3', 'Name of Coding System', OM2.6.6/OM2.6.6.3, '20px', 'normal', position(), last())"
                        />
                    </xsl:if>
                </xsl:for-each>
                <xsl:for-each select="OM2.7">
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('OM2.7', position(), last())"/>
                        </th>
                    ...
                    <xsl:if test="exists(OM2.7.1)">
                        <tr>
                            <th>
                                <xsl:value-of
                                    select="util:posValue-if-repeat('OM2.7.1', position(), last())"
                                />
                            </th>
                        ...
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.7.1.1', 'Low Value', OM2.7.1/OM2.7.1.1, '20px', 'normal', position(), last())"/>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.7.1.2', 'High Value', OM2.7.1/OM2.7.1.2, '20px', 'normal', position(), last())"
                        />
                    </xsl:if>
                    <xsl:if test="exists(OM2.7.2)">
                        <tr>
                            <th>
                                <xsl:value-of
                                    select="util:posValue-if-repeat('OM2.7.2', position(), last())"
                                />
                            </th>
                        ...
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.7.2.1', 'Identifier', OM2.7.2/OM2.7.2.1, '20px', 'normal', position(), last())"/>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.7.2.2', 'Text', OM2.7.2/OM2.7.2.2, '20px', 'normal', position(), last())"/>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.7.2.3', 'Name of Coding System', OM2.7.2/OM2.7.2.3, '20px', 'normal', position(), last())"
                        />
                    </xsl:if>
                    <xsl:if test="exists(OM2.7.6)">
                        <tr>
                            <th>
                                <xsl:value-of
                                    select="util:posValue-if-repeat('OM2.7.6', position(), last())"
                                />
                            </th>
                            <th style="text-indent:10px">Race/Subspecies</th>
                            <th/>
                        ...
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.7.6.1', 'Identifier', OM2.7.6/OM2.7.6.1, '20px', 'normal', position(), last())"/>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.7.6.2', 'Text', OM2.7.6/OM2.7.6.2, '20px', 'normal', position(), last())"/>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.7.6.3', 'Name of Coding System', OM2.7.6/OM2.7.6.3, '20px', 'normal', position(), last())"
                        />
                    </xsl:if>
                </xsl:for-each>
                <xsl:for-each select="OM2.8">
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('OM2.8', position(), last())"/>
                        </th>
                    ...
                    <xsl:if test="exists(OM2.8.1)">
                        <tr>
                            <th>
                                <xsl:value-of
                                    select="util:posValue-if-repeat('OM2.8.1', position(), last())"
                                />
                            </th>
                            <th style="text-indent:10px">Numeric Range</th>
                            <th/>
                        ...
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.8.1.1', 'Low Value', OM2.8.1/OM2.8.1.1, '20px', 'normal', position(), last())"/>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.8.1.2', 'High Value', OM2.8.1/OM2.8.1.2, '20px', 'normal', position(), last())"
                        />
                    </xsl:if>
                    <xsl:if test="exists(OM2.8.2)">
                        <tr>
                            <th>
                                <xsl:value-of
                                    select="util:posValue-if-repeat('OM2.8.2', position(), last())"
                                />
                            </th>
                            <th style="text-indent:10px">Administrative Sex</th>
                            <th/>
                        ...
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.8.2.1', 'Identifier', OM2.8.2/OM2.8.2.1, '20px', 'normal', position(), last())"/>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.8.2.2', 'Text', OM2.8.2/OM2.8.2.2, '20px', 'normal', position(), last())"/>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.8.2.3', 'Name of Coding System', OM2.8.2/OM2.8.2.3, '20px', 'normal', position(), last())"
                        />
                    </xsl:if>
                    <xsl:if test="exists(OM2.8.6)">
                        <tr>
                            <th>
                                <xsl:value-of
                                    select="util:posValue-if-repeat('OM2.8.6', position(), last())"
                                />
                            </th>
                            <th style="text-indent:10px">Race/Subspecies</th>
                            <th/>
                        ...
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.8.6.1', 'Identifier', OM2.8.6/OM2.8.6.1, '20px', 'normal', position(), last())"/>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.8.6.2', 'Text', OM2.8.6/OM2.8.6.2, '20px', 'normal', position(), last())"/>
                        <xsl:copy-of
                            select="util:ID-text-format-withPosition('OM2.8.6.3', 'Name of Coding System', OM2.8.6/OM2.8.6.3, '20px', 'normal', position(), last())"
                        />
                    </xsl:if>
                </xsl:for-each>
            </tbody>
    ...
    <xsl:template name="categorial-testInfo">
        <table>
            <xsl:call-template name="headerforIV">
                <xsl:with-param name="title">Categorial Test Information</xsl:with-param>
            </xsl:call-template>
            ...
            <tbody>
                ...
                <xsl:for-each select="OM3.4">
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('OM3.4', position(), last())"/>
                        </th>
                    ...
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM3.4.1', 'Identifier', OM3.4.1, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM3.4.2', 'Text', OM3.4.2, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM3.4.3', 'Name of Coding System', OM3.4.3, '20px', 'normal', position(), last())"
                    />
                </xsl:for-each>
                <xsl:for-each select="OM3.5">
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('OM3.5', position(), last())"/>
                        </th>
                    ...
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM3.5.1', 'Identifier', OM3.5.1, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM3.5.2', 'Text', OM3.5.2, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM3.5.3', 'Name of Coding System', OM3.5.3, '20px', 'normal', position(), last())"
                    />
                </xsl:for-each>
                <xsl:copy-of
    ...
    <xsl:template name="specimen-incorp">
        <table>
            <xsl:call-template name="headerforIV">
                <xsl:with-param name="title">Specimen Information</xsl:with-param>
            </xsl:call-template>
            ...
            <tbody>
                ...
                <xsl:for-each select="OM4.3">
                    <xsl:variable name="pos" select="position()"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM4.3', 'Container Description', ., '0px', 'normal', position(), last())"/>

                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM4.4', 'Container Volume', ../OM4.4[$pos], '0px', 'normal', position(), last())"/>

                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('OM4.5', position(), last())"/>
                        </th>
                    ...
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM4.5.2', 'Text', ../OM4.5[$pos]/OM4.5.2, '0px', 'normal', position(), last())"
                    />
                </xsl:for-each>
    ...
    <xsl:template name="observation-batteries">
        <table>
            <xsl:call-template name="headerforIV">
                <xsl:with-param name="title">Observation Batteries(sets)</xsl:with-param>
            </xsl:call-template>
            ...
            <tbody>
                ...
                <xsl:for-each select="OM5.2">
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('OM5.2', position(), last())"/>
                        </th>
                    ...
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM5.2.1', 'Identifier', OM5.2.1, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM5.2.2', 'Text', OM5.2.2, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('OM5.2.3', 'Name of Coding System', OM5.2.3, '20px', 'normal', position(), last())"
                    />
                </xsl:for-each>
            </tbody>
        </table>
    ...
    <xsl:template name="chargeDescription">
        <table>
            <xsl:call-template name="headerforIV">
                <xsl:with-param name="title">Charge Description</xsl:with-param>
            </xsl:call-template>
            ...
            <tbody>
                ...
                <xsl:for-each select="CDM.7">
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('CDM.7', position(), last())"/>
                        </th>
                    ...
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('CDM.7.1', 'Identifier', CDM.7.1, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('CDM.7.2', 'Text', CDM.7.2, '20px', 'normal', position(), last())"
                    />
                </xsl:for-each>
            </tbody>
        </table>
    ...
    <xsl:template name="payerInfo">
        <table>
            <xsl:call-template name="headerforIV">
                <xsl:with-param name="title">Payer Information</xsl:with-param>
            </xsl:call-template>
            ...
            <tbody>
                ...
                <xsl:for-each select="PM1.2">
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('PM1.2', position(), last())"/>
                        </th>
                    ...
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('PM1.2.1', 'ID Number', PM1.2.1, '20px', 'normal', position(), last())"/>
                    <tr>
                        <th>
                            <xsl:value-of
                                select="util:posValue-if-repeat('PM1.2.4', position(), last())"/>
                        </th>
                    ...
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('PM1.2.4.1', 'Namespace ID', PM1.2.4/PM1.2.4.1, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('PM1.2.4.2', 'Universal ID', PM1.2.4/PM1.2.4.2, '20px', 'normal', position(), last())"/>
                    <xsl:copy-of
                        select="util:ID-text-format-withPosition('PM1.2.4.3', 'Universal ID Type', PM1.2.4/PM1.2.4.3, '20px', 'normal', position(), last())"
                    />
                </xsl:for-each>
            </tbody>
        </table>
    ...
    <xsl:template name="coveragePolicy">
        <table>
            <xsl:call-template name="headerforIV">
                <xsl:with-param name="title">Coverage Policy</xsl:with-param>
            </xsl:call-template>
        ...
        <html>
            <head>
                ...
                <style type="text/css">
                   ...
                   font-family:Times New Roman;
                    ...
                    .jurorContainer fieldset table tbody tr[id = noColor] th{
                        font-weight:bold;
                        text-align:left;
                        background:none;
                    }
                    .jurorContainer fieldset table tr[id = header] th{
                        text-align:left;
                        background:#4682B4;
                        color:white;
                        font-style:italic;
            ...
            <body>
                <div class="jurorContainer">
                    ...
                    <fieldset>
                        <h3>INSTRUCTIONS</h3>
                            <pre><xsl:value-of select="$instructions"/></pre>
                    </fieldset>
                    <br/>
                    <fieldset>
                        ...
                        <xsl:if test="exists($condition)">
                            <table id="orderablePanel">
                                <thead>
                                    <tr>
                                        <th colspan="2" style="width:60%">Orderable Atomic Tests and
                                            /or Panels</th>
                                        <th style="width:40%">Tester Comment</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <th style="width:30%">Laboratary Name</th>
                                        <th style="width:30%">Name of the Test/Panel*</th>
                                        <th/>
                                    </tr>
                        ...
                        <xsl:if test="exists(//MFE/MFE.1[. = 'MDC'])">
                            <table id="orderablePanel">
                                <thead>
                                    <tr>
                                        <th colspan="2" style="width:60%">Deactivated Atomic Tests
                                            and /or Panels</th>
                                        <th style="width:40%">Tester Comment</th>
                                    </tr>
                                </thead>
                                ...
                                <xsl:if test="OM1.12[. != 'Y']">
                                    ...
                                    <xsl:if test="string-length($CPOE) != 0">
                                        <table>
                                            <thead>
                                                <tr id="header">
                                                  <th colspan="2" style="width:60%"> Panel
                                                  Component: <xsl:value-of select="OM1.2/OM1.2.2"
                                                  /></th>
                                                  <th style="width:40%">Tester Comment</th>
                                                </tr>
                                            </thead>
                                    ...
                                    <xsl:when test="../../..[@id = 'MFN_M08']">
                                        <xsl:if test="string-length($specimen) != 0">
                                            <table>
                                                <thead>
                                                  <tr>
                                                  <th colspan="2" style="width:60%">Atomic Test :
                                        ...
                                        <xsl:if test="string-length($Admin) != 0">
                                            <table>
                                                <thead>
                                                  ...
                                                  <tr id="header">
                                                  <th colspan="3" style="width:60%">Panel Component
                                                  :<xsl:value-of select="OM1.2/OM1.2.2"/></th>
                                                  <th style="width:40%">Tester Comment</th>
                                                  </tr>
                                                </thead>
                    ...
                    <fieldset>
                        ...
                        <xsl:for-each-group select="//MFE/.." group-by="MFE/MFE.4/MFE.4.2">
                            ...
                            <xsl:choose>
                                ...
                                <xsl:when test="../..[@id = 'MFN_M18']/current-group()">
                                    <xsl:if
                                        test="exists(current-group()/MFN_M18.MF_PAYER.PAYER_MF_Entry/PM1)">
                                        <xsl:for-each
                                            select="current-group()/MFN_M18.MF_PAYER.PAYER_MF_Entry/PM1">
