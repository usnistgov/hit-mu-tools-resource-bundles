<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xi="http://www.w3.org/2001/XInclude" xmlns:util="http://hl7.nist.gov/data-specs/util" exclude-result-prefixes="xs" version="2.0">
	...
	<xsl:variable name="version" select="'2.9.9'"/>
	<!-- - - - - - - - - - - - - - - - - - - - - -  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - - - - - - - -->
	<!-- - - - - - - - - - - - - - - - - - - - - -  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - - - - - - - -->
...
.9 LRI lab results
	...
	<xsl:template match="ORC" mode="LRI">
		...
		<xsl:for-each select="..//OBX">
			<xsl:variable name="notes">
				<xsl:for-each select="..//NTE">
					<xsl:value-of select="concat(current()//NTE.3, $nl)"/>
				</xsl:for-each>
			</xsl:variable>
	...
	</xsl:function><xsl:function xmlns:xalan="http://xml.apache.org/xslt" name="util:elements-with-colspan">
	...
	</xsl:function><xsl:function xmlns:xalan="http://xml.apache.org/xslt" name="util:element-var-cols">
		<xsl:param name="name"/>
		<xsl:param name="value"/>
		<xsl:param name="cols" as="xs:integer"/>
		<xsl:param name="ind"/>
	...
	</xsl:function><xsl:function xmlns:xalan="http://xml.apache.org/xslt" name="util:or5">
		<xsl:param name="val1"/>
		<xsl:param name="val2"/>
		<xsl:param name="val3"/>
		<xsl:param name="val4"/>
	...
	</xsl:function><xsl:function xmlns:xalan="http://xml.apache.org/xslt" name="util:element1">
		<xsl:param name="val"/>
		<xsl:param name="ind"/>
		<xsl:choose>
	...
	</xsl:function><xsl:function xmlns:xalan="http://xml.apache.org/xslt" name="util:elements9-header">
		<xsl:param name="val1"/>
		<xsl:param name="val2"/>
		<xsl:param name="val3"/>
		<xsl:param name="val4"/>
	...
	</xsl:function><xsl:function xmlns:xalan="http://xml.apache.org/xslt" name="util:elements9">
		<xsl:param name="val1"/>
		<xsl:param name="val2"/>
		<xsl:param name="val3"/>
		<xsl:param name="val4"/>
	...
	</xsl:function><xsl:function xmlns:xalan="http://xml.apache.org/xslt" name="util:obx-result">
		<xsl:param name="obx"/>
		<xsl:choose>
